...
<form action="../src/search" method="post" class="search-form">

<h1>会員情報削除画面(必須*)</h1>

会員番号
<input type = "text" class ="number" name="memberNo" >
<input type ="submit" class="btn" name="view" value="表示">

</form>

<form action="../src/delete" method="post" class="form">
会員番号(*)
<input type = "text" class ="box" name="memberNo">
名前(*)
<input type = "text" class ="box" name="name" value="${memberBean[0].name}">
年齢(*)
<input type = "text" class="box" name="age" value="${memberBean[0].age}">
生年(*)
...
生月(*)
<select name="birthMonth" class="select">
